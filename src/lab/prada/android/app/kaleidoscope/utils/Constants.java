...
public class Constants {
    ...
    public static final int SUPPORTED_FRAME_NUMBER = SUPPORTED_FRAME_WIDTH
            * SUPPORTED_FRAME_HEIGHT;

    /** it's not use now. */
    public static Frame findFrame(int numOfImages)
    ...
    /** it's not use now. */
    public static Vector<Frame> frames = new Vector<Frame>(
            SUPPORTED_FRAME_NUMBER);
    static {
        /**
